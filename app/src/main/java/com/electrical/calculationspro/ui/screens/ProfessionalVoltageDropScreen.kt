...
fun ProfessionalVoltageDropScreen(
    ...
    Column(
         ...
         *
         * The back arrow is ALWAYS visible.
         * If onBack exists, it is used.
         * Otherwise the current Activity is finished.
         */
        Row(
            modifier = Modifier
                .fillMaxWidth()
 ...
 *
 * No FlowRow.
 * No experimental Compose API.
 *
 * weight() is used only inside RowScope.
 */
@Composable
