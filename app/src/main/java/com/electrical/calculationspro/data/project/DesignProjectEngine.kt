...
STEP 1 WATER ENGINEERING Calculates: Flow TDH Hydraulic power Shaft power Motor input power Energy
*/
result =
WaterDesignEngine.recalculate(
result
...
STEP 2 SEWAGE ENGINEERING Calculates: Sewage TDH Pump motor power Energy
*/
result =
SewageDesignEngine.recalculate(
result
...
STEP 3 ELECTRICAL ENGINEERING ElectricalDesignEngine now sees the calculated water/sewage pump motor powers. It creates synchronized electrical loads and then calculates their currents and panel totals.
*/
result =
ElectricalDesignEngine.recalculate(
result
...
Save only the final project state. This prevents unnecessary intermediate persistence during a complete calculation.
*/
...
Project validation is intentionally performed after all discipline calculations have completed.
*/
val validation =
