...
object BreakerCatalog {
    ...
    private val commonRatings = listOf(
        2.0,
        4.0,
        6.0,
        10.0,
    ...
    fun select(
        ...
        return all()
            ...
            .filter {
                requiredBreakingCapacityKA <= 0.0 ||
                    it.breakingCapacityKA == null ||
                    it.breakingCapacityKA >= requiredBreakingCapacityKA
            }
            .sortedWith(
